...
namespace Alg {
	...
	/// <summary>
	/// Sumário para TelaExplicacaoRepeticao1
	/// </summary>
	public ref class TelaExplicacaoRepeticao1 : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaExplicacaoRepeticao1::typeid));
			...
			this->BotaoAvancar->Location = System::Drawing::Point(1189, 621);
			...
			this->BotaoAvancar->TabIndex = 29;
			this->BotaoAvancar->UseCompatibleTextRendering = true;
			this->BotaoAvancar->UseVisualStyleBackColor = false;
			this->BotaoAvancar->Click += gcnew System::EventHandler(this, &TelaExplicacaoRepeticao1::BotaoAvancar_Click);
			// 
			// BotaoMenuPrincipal
			// 
			...
			this->BotaoMenuPrincipal->Location = System::Drawing::Point(19, 585);
			...
			this->BotaoMenuPrincipal->TabIndex = 28;
			...
			this->BotaoMenuPrincipal->Click += gcnew System::EventHandler(this, &TelaExplicacaoRepeticao1::BotaoMenuPrincipal_Click);
			this->BotaoMenuPrincipal->MouseLeave += gcnew System::EventHandler(this, &TelaExplicacaoRepeticao1::BotaoMenuPrincipal_MouseLeave);
			this->BotaoMenuPrincipal->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaExplicacaoRepeticao1::BotaoMenuPrincipal_MouseMove);
			// 
			// LetreiroAlgoritmo
			// 
			...
			this->LetreiroAlgoritmo->Font = (gcnew System::Drawing::Font(L"Times New Roman", 17));
			this->LetreiroAlgoritmo->Location = System::Drawing::Point(55, 261);
			this->LetreiroAlgoritmo->Name = L"LetreiroAlgoritmo";
			this->LetreiroAlgoritmo->Size = System::Drawing::Size(285, 314);
			...
			this->letreiroInformacao->Font = (gcnew System::Drawing::Font(L"Times New Roman", 18));
			this->letreiroInformacao->Location = System::Drawing::Point(50, 145);
			this->letreiroInformacao->Name = L"letreiroInformacao";
			this->letreiroInformacao->Size = System::Drawing::Size(1152, 108);
			...
			this->LetreiroTitulo->Location = System::Drawing::Point(459, 9);
			this->LetreiroTitulo->Name = L"LetreiroTitulo";
			this->LetreiroTitulo->Size = System::Drawing::Size(335, 78);
			this->LetreiroTitulo->TabIndex = 24;
			this->LetreiroTitulo->Text = L"Enquanto";
			// 
			// ImagemBotaoCinza
			// 
			this->ImagemBotaoCinza->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"ImagemBotaoCinza.Image")));
			this->ImagemBotaoCinza->Location = System::Drawing::Point(176, 46);
			...
			this->ImagemBotaoVermelho->Location = System::Drawing::Point(144, 46);
			...
			this->buttonC3->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"buttonC3.BackgroundImage")));
			this->buttonC3->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			...
			this->buttonC3->Font = (gcnew System::Drawing::Font(L"Century Gothic", 20));
			this->buttonC3->Location = System::Drawing::Point(497, 401);
			this->buttonC3->Margin = System::Windows::Forms::Padding(10);
			this->buttonC3->Name = L"buttonC3";
			this->buttonC3->Size = System::Drawing::Size(255, 62);
			this->buttonC3->TabIndex = 76;
			this->buttonC3->Text = L"Linguagem C";
			this->buttonC3->UseCompatibleTextRendering = true;
			this->buttonC3->UseVisualStyleBackColor = false;
			this->buttonC3->Click += gcnew System::EventHandler(this, &TelaExplicacaoRepeticao1::buttonC3_Click);
			// 
			// TelaExplicacaoRepeticao1
			// 
			...
			this->Name = L"TelaExplicacaoRepeticao1";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Alg+";
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &TelaExplicacaoRepeticao1::TelaExplicacaoRepeticao1_FormClosed);
...
private: System::Void TelaExplicacaoRepeticao1_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e) {
			 fecharJogo();
}
