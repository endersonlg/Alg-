...
namespace Alg {
	...
	/// </summary>
	public ref class TelaQuestao2 : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaQuestao2::typeid));
			...
			this->BotaoOpcaoDeResposta2->Location = System::Drawing::Point(1078, 210);
			this->BotaoOpcaoDeResposta2->Margin = System::Windows::Forms::Padding(10);
			this->BotaoOpcaoDeResposta2->Name = L"BotaoOpcaoDeResposta2";
			this->BotaoOpcaoDeResposta2->Size = System::Drawing::Size(163, 40);
			...
			this->BotaoOpcaoDeResposta2->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta2_Click);
			this->BotaoOpcaoDeResposta2->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta2_MouseLeave);
			this->BotaoOpcaoDeResposta2->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta2_MouseMove);
			// 
			...
			this->BotaoOpcaoDeResposta3->Location = System::Drawing::Point(1078, 270);
			this->BotaoOpcaoDeResposta3->Margin = System::Windows::Forms::Padding(10);
			this->BotaoOpcaoDeResposta3->Name = L"BotaoOpcaoDeResposta3";
			this->BotaoOpcaoDeResposta3->Size = System::Drawing::Size(163, 40);
			this->BotaoOpcaoDeResposta3->TabIndex = 3;
			this->BotaoOpcaoDeResposta3->Text = L"Leia(Area)";
			this->BotaoOpcaoDeResposta3->UseCompatibleTextRendering = true;
			this->BotaoOpcaoDeResposta3->UseVisualStyleBackColor = false;
			this->BotaoOpcaoDeResposta3->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta3_Click);
			this->BotaoOpcaoDeResposta3->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta3_MouseLeave);
			this->BotaoOpcaoDeResposta3->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta3_MouseMove);
			// 
			...
			this->BotaoOpcaoDeResposta4->Location = System::Drawing::Point(1078, 330);
			this->BotaoOpcaoDeResposta4->Margin = System::Windows::Forms::Padding(10);
			this->BotaoOpcaoDeResposta4->Name = L"BotaoOpcaoDeResposta4";
			this->BotaoOpcaoDeResposta4->Size = System::Drawing::Size(163, 40);
			this->BotaoOpcaoDeResposta4->TabIndex = 4;
			this->BotaoOpcaoDeResposta4->Text = L"Real";
			this->BotaoOpcaoDeResposta4->UseCompatibleTextRendering = true;
			this->BotaoOpcaoDeResposta4->UseVisualStyleBackColor = false;
			this->BotaoOpcaoDeResposta4->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta4_Click);
			this->BotaoOpcaoDeResposta4->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta4_MouseLeave);
			this->BotaoOpcaoDeResposta4->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta4_MouseMove);
			// 
			// TempoIntervaloResposta
			// 
			this->TempoIntervaloResposta->Enabled = true;
			this->TempoIntervaloResposta->Interval = 500;
			this->TempoIntervaloResposta->Tick += gcnew System::EventHandler(this, &TelaQuestao2::TimerIntervaloResposta_Tick);
			// 
			...
			this->BotaoOpcaoDeResposta5->Location = System::Drawing::Point(1078, 390);
			this->BotaoOpcaoDeResposta5->Margin = System::Windows::Forms::Padding(10);
			this->BotaoOpcaoDeResposta5->Name = L"BotaoOpcaoDeResposta5";
			this->BotaoOpcaoDeResposta5->Size = System::Drawing::Size(163, 40);
			this->BotaoOpcaoDeResposta5->TabIndex = 5;
			this->BotaoOpcaoDeResposta5->Text = L"Leia(Raio)";
			this->BotaoOpcaoDeResposta5->UseCompatibleTextRendering = true;
			this->BotaoOpcaoDeResposta5->UseVisualStyleBackColor = false;
			this->BotaoOpcaoDeResposta5->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta5_Click);
			this->BotaoOpcaoDeResposta5->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta5_MouseLeave);
			this->BotaoOpcaoDeResposta5->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta5_MouseMove);
			// 
			...
			this->BotaoOpcaoDeResposta1->Location = System::Drawing::Point(1078, 150);
			this->BotaoOpcaoDeResposta1->Margin = System::Windows::Forms::Padding(10);
			this->BotaoOpcaoDeResposta1->Name = L"BotaoOpcaoDeResposta1";
			this->BotaoOpcaoDeResposta1->Size = System::Drawing::Size(163, 40);
			this->BotaoOpcaoDeResposta1->TabIndex = 1;
			this->BotaoOpcaoDeResposta1->Text = L"Literal";
			this->BotaoOpcaoDeResposta1->UseCompatibleTextRendering = true;
			this->BotaoOpcaoDeResposta1->UseVisualStyleBackColor = false;
			this->BotaoOpcaoDeResposta1->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta1_Click);
			this->BotaoOpcaoDeResposta1->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta1_MouseLeave);
			this->BotaoOpcaoDeResposta1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoOpcaoDeResposta1_MouseMove);
			// 
			// letreiroAlgoritmo
			// 
			...
			this->letreiroAlgoritmo->Size = System::Drawing::Size(304, 299);
			...
			this->LetreiroResposta2->Location = System::Drawing::Point(34, 310);
			...
			this->LetreiroOpcao->Location = System::Drawing::Point(894, 134);
			...
			this->LetreiroResposta1->BackColor = System::Drawing::Color::White;
			...
			this->LetreiroResposta1->Location = System::Drawing::Point(86, 255);
			...
			this->BotaoReiniciar->Location = System::Drawing::Point(483, 525);
			this->BotaoReiniciar->Name = L"BotaoReiniciar";
			this->BotaoReiniciar->Size = System::Drawing::Size(207, 54);
			...
			this->BotaoReiniciar->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoReiniciar_Click);
			this->BotaoReiniciar->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoReiniciar_MouseLeave);
			this->BotaoReiniciar->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoReiniciar_MouseMove);
			// 
			// letreiroEnunciado
			// 
			...
			this->letreiroEnunciado->Size = System::Drawing::Size(1213, 62);
			this->letreiroEnunciado->TabIndex = 13;
			this->letreiroEnunciado->Text = L"Calcule a área de uma circunferência. A entrada contém um valor de ponto flutuant"
				L"e (dupla precisão).\r\nA fórmula para calcular a área  é: Área = Pi*Raio^2. Consid"
				L"ere Pi=3,14\r\n";
			...
			this->letreiroLinhaTracada->Location = System::Drawing::Point(-10, 86);
			this->letreiroLinhaTracada->Name = L"letreiroLinhaTracada";
			this->letreiroLinhaTracada->Size = System::Drawing::Size(1319, 13);
			...
			this->BotaoSair->Size = System::Drawing::Size(344, 50);
			...
			this->BotaoSair->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoSair_Click);
			this->BotaoSair->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoSair_MouseLeave);
			this->BotaoSair->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoSair_MouseMove);
			// 
			// ImagemCorreto
			// 
			...
			this->ImagemCorreto->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"ImagemCorreto.Image")));
			this->ImagemCorreto->Location = System::Drawing::Point(696, 525);
			...
			this->ImagemErrado->Location = System::Drawing::Point(696, 525);
			...
			this->BotaoAvancar->Location = System::Drawing::Point(483, 525);
			this->BotaoAvancar->Name = L"BotaoAvancar";
			this->BotaoAvancar->Size = System::Drawing::Size(207, 54);
			...
			this->BotaoAvancar->Click += gcnew System::EventHandler(this, &TelaQuestao2::BotaoAvancar_Click);
			this->BotaoAvancar->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoAvancar_MouseLeave);
			this->BotaoAvancar->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoAvancar_MouseMove);
			// 
			// BotaoTestar
			// 
			...
			this->BotaoTestar->Click += gcnew System::EventHandler(this, &TelaQuestao2::botaoTestar_Click_1);
			this->BotaoTestar->MouseLeave += gcnew System::EventHandler(this, &TelaQuestao2::BotaoTestar_MouseLeave);
			this->BotaoTestar->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::BotaoTestar_MouseMove);
			// 
			// LetreiroTempoTotal
			// 
			...
			this->LetreiroTempoTotal->Location = System::Drawing::Point(603, 99);
			...
			this->TempoContadorTotal->Tick += gcnew System::EventHandler(this, &TelaQuestao2::TempoContadorTotal_Tick);
			// 
			...
			this->CaixaDeTextoResposta1->Location = System::Drawing::Point(91, 226);
			this->CaixaDeTextoResposta1->MaxLength = 12;
			this->CaixaDeTextoResposta1->Name = L"CaixaDeTextoResposta1";
			this->CaixaDeTextoResposta1->Size = System::Drawing::Size(88, 34);
			this->CaixaDeTextoResposta1->TabIndex = 20;
			this->CaixaDeTextoResposta1->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::CaixaDeTextoResposta1_MouseClick);
			this->CaixaDeTextoResposta1->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &TelaQuestao2::CaixaDeTextoResposta1_KeyPress);
			// 
			// CaixaDeTextoResposta2
			// 
			this->CaixaDeTextoResposta2->Cursor = System::Windows::Forms::Cursors::IBeam;
			...
			this->CaixaDeTextoResposta2->Location = System::Drawing::Point(114, 333);
			this->CaixaDeTextoResposta2->MaxLength = 30;
			this->CaixaDeTextoResposta2->Name = L"CaixaDeTextoResposta2";
			this->CaixaDeTextoResposta2->Size = System::Drawing::Size(171, 34);
			this->CaixaDeTextoResposta2->TabIndex = 21;
			this->CaixaDeTextoResposta2->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &TelaQuestao2::CaixaDeTextoResposta2_MouseClick);
			this->CaixaDeTextoResposta2->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &TelaQuestao2::CaixaDeTextoResposta2_KeyPress);
			// 
			// ImagemBotaoCinza
			// 
			this->ImagemBotaoCinza->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"ImagemBotaoCinza.Image")));
			this->ImagemBotaoCinza->Location = System::Drawing::Point(442, 150);
			this->ImagemBotaoCinza->Name = L"ImagemBotaoCinza";
			this->ImagemBotaoCinza->Size = System::Drawing::Size(10, 10);
			this->ImagemBotaoCinza->TabIndex = 27;
			...
			this->ImagemAjuda1->Location = System::Drawing::Point(196, 226);
			this->ImagemAjuda1->Name = L"ImagemAjuda1";
			this->ImagemAjuda1->Size = System::Drawing::Size(25, 25);
			this->ImagemAjuda1->TabIndex = 28;
			this->ImagemAjuda1->TabStop = false;
			this->toolTip1->SetToolTip(this->ImagemAjuda1, L"Escreva o tipo de variável que guarda valores com casas decimais.");
			// 
			// ImagemAjuda2
			// 
			...
			this->ImagemAjuda2->Location = System::Drawing::Point(291, 342);
			this->ImagemAjuda2->Name = L"ImagemAjuda2";
			this->ImagemAjuda2->Size = System::Drawing::Size(25, 25);
			this->ImagemAjuda2->TabIndex = 31;
			this->ImagemAjuda2->TabStop = false;
			this->toolTip1->SetToolTip(this->ImagemAjuda2, L"Escreva a fórmula para descobrir a área (Á fórmula encontra-se no enunciado).");
			// 
			// TelaQuestao2
			// 
			...
			this->Name = L"TelaQuestao2";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Alg+";
			this->TransparencyKey = System::Drawing::Color::DarkRed;
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &TelaQuestao2::TelaQuestao2_FormClosed);
...
#pragma endregion
	...
	private: System::Void botaoTestar_Click_1(System::Object^  sender, System::EventArgs^  e) {
			 System:Diagnostics::Process::Start("teste\\Questao2.exe");
	}
...
private: System::Void TelaQuestao2_FormClosed(System::Object^  sender, System::Windows::Forms::FormClosedEventArgs^  e) {
			 fecharJogo();
}
